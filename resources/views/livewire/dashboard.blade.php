        ...
        <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-lg shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold mt-2">{{ number_format($stats['total_stock']) }}</p>
                </div>
        ...
        <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold mt-2">Rp {{ number_format($stats['total_sales'], 0, ',', '.') }}</p>
                    <p class="text-purple-100 text-xs mt-1">Hari ini: Rp {{ number_format($stats['today_sales'], 0, ',', '.') }}</p>
                </div>
        ...
        <div class="bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-lg shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold mt-2">Rp {{ number_format($stats['total_profit'], 0, ',', '.') }}</p>
                    <p class="text-yellow-100 text-xs mt-1">Hari ini: Rp {{ number_format($stats['today_profit'], 0, ',', '.') }}</p>
                </div>
    ...
    <div class="bg-red-50 border-l-4 border-red-500 p-4 mb-6 rounded-lg shadow">
        <div class="flex items-center">
            ...
            <div class="flex-1">
                ...
                <p class="text-sm text-red-700">Terdapat <span class="font-bold">{{ $stats['low_stock_count'] }}</span> produk dengan stok di bawah minimum.</p>
            </div>
            <a href="{{ route('products.index') }}" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition">
                Lihat Detail
            </a>
        </div>
    </div>
