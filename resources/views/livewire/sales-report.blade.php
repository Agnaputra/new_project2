        ...
        <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-lg shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold mt-2">{{ number_format($totalTransactions) }}</p>
                </div>
        ...
        <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold mt-2">Rp {{ number_format($averageTransaction, 0, ',', '.') }}</p>
                </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center">
                            ...
                            <p class="mt-2 text-sm text-gray-500">Tidak ada data penjualan untuk periode ini</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
