                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->deskripsi): ?>
                                    <div class="text-xs text-gray-500 truncate max-w-xs"><?php echo e(Str::limit($product->deskripsi, 50)); ?></div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">
                                    <span class="font-medium">Rp <?php echo e(number_format($product->harga_jual, 0, ',', '.')); ?></span>
                                </div>
                                <div class="text-xs text-gray-500">
                                    Beli: Rp <?php echo e(number_format($product->harga_beli, 0, ',', '.')); ?> • Margin: <?php echo e($product->margin); ?>%
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->is_low_stock): ?>
                                    <span class="px-2 py-1 text-xs font-semibold rounded-full bg-red-100 text-red-800">
                                        ⚠️ <?php echo e($product->stok); ?> (Rendah)
                                    </span>
                                <?php else: ?>
                                ...
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <div class="text-xs text-gray-500 mt-1">Min: <?php echo e($product->stok_minimum); ?></div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                ...
                                <button wire:click="delete(<?php echo e($product->id); ?>)" 
                                        wire:confirm="Yakin ingin menghapus produk '<?php echo e($product->nama); ?>'?"
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
        ...
        <div class="bg-white rounded-lg shadow p-4">
            ...
            <div class="text-2xl font-bold text-red-600">
                <?php echo e(\App\Models\Product::lowStock()->count()); ?>

            </div>
        </div>
        <div class="bg-white rounded-lg shadow p-4">
            <div class="text-sm text-gray-500">Kategori</div>
            <div class="text-2xl font-bold text-gray-900"><?php echo e($kategoris->count()); ?></div>
        </div>
    </div>
</div><?php /**PATH C:\laragon\www\new_project2\inventory-system\resources\views/livewire/product-list.blade.php ENDPATH**/ ?>