...
class ProductForm extends Component
{
    ...
    {
        $hargaBeli = $this->harga_beli !== null ? (float) $this->harga_beli : 0;
        $margin = $this->margin !== null ? (float) $this->margin : 0;
    ...
    public function save()
    {
        ...
        try {
            ...
            throw $e; // Re-throw agar Livewire bisa handle error dengan benar
        }
        ...
        $data = [
            'nama' => trim($this->nama),
            'kategori' => $this->kategori,
            'harga_beli' => $this->harga_beli !== null ? (float) $this->harga_beli : 0,
            'margin' => $this->margin !== null ? (float) $this->margin : 0,
            'stok' => $this->stok !== null ? (int) $this->stok : 0,
            'stok_minimum' => $this->stok_minimum !== null ? (int) $this->stok_minimum : 0,
    ...
    public function render()
    {
        return view('livewire.product-form', [
            'title' => $this->isEdit ? 'Edit Produk' : 'Tambah Produk'
        ]);
    }
}